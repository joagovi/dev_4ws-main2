...
mis_mensajes__msg__MotorDatos__init(mis_mensajes__msg__MotorDatos * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    mis_mensajes__msg__MotorDatos__fini(msg);
    return false;
  }
  // rpm
  // current
...
mis_mensajes__msg__MotorDatos__create()
{
  ...
  mis_mensajes__msg__MotorDatos * msg = (mis_mensajes__msg__MotorDatos *)allocator.allocate(sizeof(mis_mensajes__msg__MotorDatos), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mis_mensajes__msg__MotorDatos));
  bool success = mis_mensajes__msg__MotorDatos__init(msg);
  if (!success) {
...
mis_mensajes__msg__MotorDatos__Sequence__init(mis_mensajes__msg__MotorDatos__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mis_mensajes__msg__MotorDatos * data = NULL;

  if (size) {
    data = (mis_mensajes__msg__MotorDatos *)allocator.zero_allocate(size, sizeof(mis_mensajes__msg__MotorDatos), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mis_mensajes__msg__MotorDatos__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        mis_mensajes__msg__MotorDatos__fini(&data[i - 1]);
      }
...
mis_mensajes__msg__MotorDatos__Sequence__fini(mis_mensajes__msg__MotorDatos__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      mis_mensajes__msg__MotorDatos__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mis_mensajes__msg__MotorDatos__Sequence * array = (mis_mensajes__msg__MotorDatos__Sequence *)allocator.allocate(sizeof(mis_mensajes__msg__MotorDatos__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mis_mensajes__msg__MotorDatos__Sequence__init(array, size);
  if (!success) {
...
mis_mensajes__msg__MotorDatos__Sequence__destroy(mis_mensajes__msg__MotorDatos__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mis_mensajes__msg__MotorDatos__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mis_mensajes__msg__MotorDatos__Sequence__are_equal(const mis_mensajes__msg__MotorDatos__Sequence * lhs, const mis_mensajes__msg__MotorDatos__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mis_mensajes__msg__MotorDatos__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mis_mensajes__msg__MotorDatos__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mis_mensajes__msg__MotorDatos);
    mis_mensajes__msg__MotorDatos * data =
      (mis_mensajes__msg__MotorDatos *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mis_mensajes__msg__MotorDatos__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          mis_mensajes__msg__MotorDatos__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!mis_mensajes__msg__MotorDatos__copy(
